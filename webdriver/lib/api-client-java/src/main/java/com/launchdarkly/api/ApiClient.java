...
import com.launchdarkly.api.auth.OAuth;

public class ApiClient {

    private String basePath = "https://app.launchdarkly.com/api/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.launchdarkly.com/api/v2
